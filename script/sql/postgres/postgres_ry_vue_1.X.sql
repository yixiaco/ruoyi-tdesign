...
-- ----------------------------
-- 一级菜单
insert into sys_menu values('1', '系统管理', '0', '11', 'system',           null, null, '', 0, 1, 'M', '1', '1', '', 'setting',   103, 1, now(), null, null, '系统管理目录');
insert into sys_menu values('6', '租户管理', '0', '12', 'tenant',           null, null, '', 0, 1, 'M', '1', '1', '', 'chart-bar',    103, 1, now(), null, null, '租户管理目录');
insert into sys_menu values('2', '系统监控', '0', '13', 'monitor',          null, null, '', 0, 1, 'M', '1', '1', '', 'chart',  103, 1, now(), null, null, '系统监控目录');
insert into sys_menu values('3', '系统工具', '0', '14', 'tool',             null, null, '', 0, 1, 'M', '1', '1', '', 'tool',     103, 1, now(), null, null, '系统工具目录');
insert into sys_menu values('4', 'PLUS官网', '0', '15', 'https://gitee.com/yixiacoco/ruoyi-tdesign', null, null, '', 1, 1, 'M', '1', '1', '', 'link',    103, 1, now(), null, null, 'tdesign官网地址');
-- 二级菜单
insert into sys_menu values('100',  '用户管理',     '1',   '1', 'user',             'system/user/index', 'User',            '', 0, 1, 'C', '1', '1', 'system:user:list',            'user',          103, 1, now(), null, null, '用户管理菜单');
insert into sys_menu values('101',  '角色管理',     '1',   '2', 'role',             'system/role/index', 'Role',            '', 0, 1, 'C', '1', '1', 'system:role:list',            'user-safety',       103, 1, now(), null, null, '角色管理菜单');
insert into sys_menu values('102',  '菜单管理',     '1',   '3', 'menus',            'system/menu/index', 'Menu',            '', 0, 1, 'C', '1', '1', 'system:menu:list',            'bulletpoint',    103, 1, now(), null, null, '菜单管理菜单');
insert into sys_menu values('103',  '部门管理',     '1',   '4', 'dept',             'system/dept/index', 'Dept',            '', 0, 1, 'C', '1', '1', 'system:dept:list',            'tree-square-dot',          103, 1, now(), null, null, '部门管理菜单');
insert into sys_menu values('104',  '岗位管理',     '1',   '5', 'post',             'system/post/index', 'Post',            '', 0, 1, 'C', '1', '1', 'system:post:list',            'user-avatar',          103, 1, now(), null, null, '岗位管理菜单');
insert into sys_menu values('105',  '字典管理',     '1',   '6', 'dict',             'system/dict/index', 'Dict',            '', 0, 1, 'C', '1', '1', 'system:dict:list',            'book',          103, 1, now(), null, null, '字典管理菜单');
insert into sys_menu values('106',  '参数设置',     '1',   '7', 'sysConfig',        'system/config/index', 'Config',        '', 0, 1, 'C', '1', '1', 'system:config:list',          'edit',          103, 1, now(), null, null, '参数设置菜单');
insert into sys_menu values('107',  '通知公告',     '1',   '8', 'notice',           'system/notice/index', 'Notice',        '', 0, 1, 'C', '1', '1', 'system:notice:list',          'mail',       103, 1, now(), null, null, '通知公告菜单');
insert into sys_menu values('108',  '日志管理',     '1',   '9', 'log',              '',                 '',                 '', 0, 1, 'M', '1', '1', '',                            'root-list',           103, 1, now(), null, null, '日志管理菜单');
insert into sys_menu values('109',  '在线用户',     '2',   '1', 'online',           'monitor/online/index', 'Online',       '', 0, 1, 'C', '1', '1', 'monitor:online:list',         'user-talk',        103, 1, now(), null, null, '在线用户菜单');
insert into sys_menu values('113',  '缓存监控',     '2',   '5', 'cache',            'monitor/cache/index', 'Cache',         '', 0, 1, 'C', '1', '1', 'monitor:cache:list',          'layers',         103, 1, now(), null, null, '缓存监控菜单');
insert into sys_menu values('114',  '表单构建',     '3',   '1', 'build',            'tool/build/index', 'Build',            '', 0, 1, 'C', '1', '1', 'tool:build:list',             'logo-windows-filled',         103, 1, now(), null, null, '表单构建菜单');
insert into sys_menu values('115',  '代码生成',     '3',   '2', 'gen',              'tool/gen/index',   'Gen',              '', 0, 1, 'C', '1', '1', 'tool:gen:list',               'code',          103, 1, now(), null, null, '代码生成菜单');
insert into sys_menu values('121',  '租户管理',     '6',   '1', 'tenant',           'system/tenant/index', 'Tenant',        '', 0, 1, 'C', '1', '1', 'system:tenant:list',          'bulletpoint',          103, 1, now(), null, null, '租户管理菜单');
insert into sys_menu values('122',  '租户套餐管理',  '6',   '2', 'tenantPackage',   'system/tenantPackage/index', 'TenantPackage',   '', 0, 1, 'C', '1', '1', 'system:tenantPackage:list',   'edit-1',          103, 1, now(), null, null, '租户套餐管理菜单');
insert into sys_menu values('123',  '客户端管理',   '1',   '12', 'client',          'system/client/index', 'Client',          '', 0, 1, 'C', '1', '1', 'system:client:list',          'internet', 103, 1, now(), null, null, '客户端管理菜单');

-- springboot-admin监控
insert into sys_menu values('117',  'Admin监控',   '2',   '5',  'Admin',            'monitor/admin/index', 'Admin',         '', 0, 1, 'C', '1', '1', 'monitor:admin:list',          'dashboard',     103, 1, now(), null, null, 'Admin监控菜单');
-- oss菜单
insert into sys_menu values('1510', '对象存储', '1', '10', 'store', NULL, NULL, NULL, 0, 1, 'M', '1', '1', NULL, 'cloud', 103, 1, now(), 1, null, '');
-- powerjob server控制台
insert into sys_menu values('120',  '任务调度中心',  '2',   '5',  'powerjob',           'monitor/powerjob/index', 'Powerjob',        '', 0, 1, 'C', '1', '1', 'monitor:powerjob:list',         'video',           103, 1, now(), null, null, 'PowerJob控制台菜单');

-- 三级菜单
insert into sys_menu values('500',  '操作日志', '108', '1', 'operlog',    'monitor/operlog/index', 'Operlog',    '', 0, 1, 'C', '1', '1', 'monitor:operlog:list',    'edit-1',          103, 1, now(), null, null, '操作日志菜单');
insert into sys_menu values('501',  '登录日志', '108', '2', 'logininfor', 'monitor/logininfor/index', 'Logininfor', '', 0, 1, 'C', '1', '1', 'monitor:logininfor:list', 'swap',    103, 1, now(), null, null, '登录日志菜单');
insert into sys_menu values('1500', 'OSS配置管理', '1510', '1', 'ossConfig', 'system/ossConfig/index', 'OssConfig', '', 0, 1, 'C', '1', '1', 'system:ossConfig:list', 'server', 103, 1, now(), 1, null, '');
insert into sys_menu values('118',  '文件管理','1510','2', 'oss','system/oss/index', 'Oss','', 0, 1, 'C', '1', '1', 'system:oss:list', 'backup',103, 1, now(), null, null, '文件管理菜单');
insert into sys_menu values('1521', 'OSS处理规则', '1510', '3', 'ossRule', 'system/ossRule/index', 'OssRule', NULL, 0, 1, 'C', '1', '1', 'system:ossRule:list', 'chevron-right-double', 103, 1, now(), 1, null, 'OSS处理规则菜单');
insert into sys_menu values('1531', '我的文件', '1510', 4, 'ossCategory', 'system/ossCategory/index', 'OssCategory', NULL, 0, 1, 'C', '1', '1', 'system:ossCategory:list', 'folder-open', 103, 1, now(), 1, now(), '我的文件菜单');
-- 用户管理按钮
...
insert into sys_menu values('1604', '文件修改', '118', '5', '#', '', '', '', 0, 1, 'F', '1', '1', 'system:oss:edit', '#', 103, 1, now(), 1, now(), '');
...
-- 应用管理
insert into sys_menu values('1701', '应用管理', 6, 3, 'app', 'system/app/index', 'App', NULL, 0, 1, 'C', '1', '1', 'system:app:list', 'app', 103, 1, now(), 1, now(), '应用管理菜单');
...
-- 消息管理
insert into sys_menu values('1801', '消息管理', '1', 11, 'messageManage', NULL, NULL, NULL, 0, 1, 'M', '1', '1', NULL, 'chat', 103, 1, now(), 1, now(), '');
-- 消息配置
insert into sys_menu values('1802', '消息配置',    '1801', 1, 'messageConfig', 'system/messageConfig/index', 'MessageConfig', NULL, 0, 1, 'C', '1', '1', 'system:messageConfig:list', 'tools', 103, 1, now(), 1, now(), '消息配置菜单');
...
-- 消息常量
insert into sys_menu values('1810', '消息常量',     '1801', 2, 'messageKey', 'system/messageKey/index', 'MessageKey', NULL, 0, 1, 'C', '1', '1', 'system:messageKey:list', 'root-list', 103, 1, now(), 1, now(), '消息常量菜单');
...
-- 消息模板
insert into sys_menu values('1820', '消息模板',    '1801', 3, 'messageTemplate', 'system/messageTemplate/index', 'MessageTemplate', NULL, 0, 1, 'C', '1', '1', 'system:messageTemplate:list', 'relativity', 103, 1, now(), 1, now(), '消息模板菜单');
...
insert into sys_menu values('1826', '发送测试消息', '1820', 6, '#', '', '', NULL, 0, 1, 'F', '1', '1', 'system:messageTemplate:test', '#', 103, 1, now(), 1, now(), '');
-- 消息发送记录
insert into sys_menu values('1830', '消息发送记录',    '1801', 4, 'messageLog', 'system/messageLog/index', 'MessageLog', NULL, 0, 1, 'C', '1', '1', 'system:messageLog:list', 'history', 103, 1, now(), 1, now(), '消息发送记录菜单');
