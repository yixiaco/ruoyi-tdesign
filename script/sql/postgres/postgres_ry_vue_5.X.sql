...
insert into sys_menu values('102',  '菜单管理',     '1',   '3', 'menus',             'system/menu/index',            '', '1', '0', 'C', '0', '0', 'system:menu:list',            'bulletpoint',    103, 1, now(), null, null, '菜单管理菜单');
...
insert into sys_menu values('106',  '参数设置',     '1',   '7', 'sysConfig',           'system/config/index',          '', '1', '0', 'C', '0', '0', 'system:config:list',          'edit',          103, 1, now(), null, null, '参数设置菜单');
...
-- oss菜单
insert into sys_menu values('1510', '对象存储', '1', '10', 'store', NULL, NULL, 1, 0, 'M', '0', '0', NULL, 'cloud', 103, 1, now(), 1, null, '');
-- xxl-job-admin控制台
...
insert into sys_menu values('1500', 'OSS配置管理', '1510', '1', 'ossConfig', 'system/ossConfig/index', '', 1, 0, 'C', '0', '0', 'system:ossConfig:list', 'server', 103, 1, now(), 1, null, '');
insert into sys_menu values('118',  '文件管理','1510','2', 'oss','system/oss/index','', 1, 0, 'C', '0', '0', 'system:oss:list', 'cloud-upload',103, 1, now(), null, null, '文件管理菜单');
insert into sys_menu values('1521', 'OSS处理规则', '1510', '3', 'ossRule', 'system/ossRule/index', NULL, 1, 0, 'C', '0', '0', 'system:ossRule:list', 'chevron-right-double', 103, 1, now(), 1, null, 'OSS处理规则菜单');
-- 用户管理按钮
...
insert into sys_menu values('1522', 'OSS处理规则查询', '1521', '1', '#', '', null, 1, 0, 'F', '0', '0', 'system:ossRule:query', '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1523', 'OSS处理规则新增', '1521', '2', '#', '', null, 1, 0, 'F', '0', '0', 'system:ossRule:add', '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1524', 'OSS处理规则修改', '1521', '3', '#', '', null, 1, 0, 'F', '0', '0', 'system:ossRule:edit', '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1525', 'OSS处理规则删除', '1521', '4', '#', '', null, 1, 0, 'F', '0', '0', 'system:ossRule:remove', '#', 103, 1, now(), null, null, '');
insert into sys_menu values('1526', 'OSS处理规则导出', '1521', '5', '#', '', null, 1, 0, 'F', '0', '0', 'system:ossRule:export', '#', 103, 1, now(), null, null, '');
-- 租户管理相关按钮
...
-- 应用管理
INSERT INTO sys_menu VALUES ('1701', '应用管理', 6, 3, 'app', 'system/app/index', NULL, 1, 0, 'C', '0', '0', 'system:app:list', 'app', 103, 1, now(), 1, now(), '应用管理菜单');
INSERT INTO sys_menu VALUES ('1702', '应用管理查询', '1701', 1, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:query', '#', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('1702', '应用管理新增', '1701', 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:add', '#', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('1703', '应用管理修改', '1701', 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:edit', '#', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('1704', '应用管理删除', '1701', 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:remove', '#', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('1705', '应用管理导出', '1701', 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:export', '#', 103, 1, now(), NULL, NULL, '');
...
insert into sys_dict_type values(11, '000000', '应用类型', 'sys_app_type', '0', 103, 1, now(), 1, now(), '应用管理列表');
...
insert into sys_dict_data values(29, '000000', 99, '其他',     '0',       'sys_oper_type',       '',   'primary', 'N', '0', 103, 1, now(), null, null, '其他操作');
insert into sys_dict_data values(18, '000000', 1,  '新增',     '1',       'sys_oper_type',       '',   'primary', 'N', '0', 103, 1, now(), null, null, '新增操作');
insert into sys_dict_data values(19, '000000', 2,  '修改',     '2',       'sys_oper_type',       '',   'primary', 'N', '0', 103, 1, now(), null, null, '修改操作');
...
insert into sys_dict_data values(30, '000000', 0, '域名', 'DOMAIN', 'sys_app_type', null, 'primary', 'N', '0', 103, 1, now(), 1, now(), null);
insert into sys_dict_data values(31, '000000', 1, '微信小程序', 'WX_XCX', 'sys_app_type', null, 'primary', 'N', '0', 103, 1, now(), 1, now(), null);
insert into sys_dict_data values(32, '000000', 2, '微信公众号', 'WX_GZH', 'sys_app_type', null, 'primary', 'N', '0', 103, 1, now(), 1, now(), null);
insert into sys_dict_data values(33, '000000', 3, 'APP', 'APP', 'sys_app_type', null, 'primary', 'N', '0', 103, 1, now(), 1, now(), null);
