...
INSERT INTO sys_menu VALUES ('1703', '应用管理新增', '1701', 2, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:add', '#', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('1704', '应用管理修改', '1701', 3, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:edit', '#', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('1705', '应用管理删除', '1701', 4, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:remove', '#', 103, 1, now(), NULL, NULL, '');
INSERT INTO sys_menu VALUES ('1706', '应用管理导出', '1701', 5, '#', '', NULL, 1, 0, 'F', '0', '0', 'system:app:export', '#', 103, 1, now(), NULL, NULL, '');
