...
-- 添加字典数据
insert into sys_dict_data values(71, '000000', 1,  '拟托管风格', '0', 'oss_url_style',  '',   '', '',  'Y', 18, 1, now(), null, null, '示例：<bucket-name>.s3.region-code.amazonaws.com');
insert into sys_dict_data values(72, '000000', 2,  '路径风格',   '1', 'oss_url_style',  '',   '', '',  'N', 18, 1, now(), null, null, '示例：s3.region-code.amazonaws.com/<bucket-name>');
