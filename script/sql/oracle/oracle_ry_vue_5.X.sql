...
insert into sys_menu values('4', 'PLUS官网', '0', '5', 'https://gitee.com/yixiacoco/ruoyi-tdesign', null, '', 0, 0, 'M', '0', '0', '', 'guide',    103, 1, sysdate, null, null, 'ruoyi_tdesign官网地址');
-- 二级菜单
...
insert into sys_menu values('500',  '操作日志', '1', '1',   'operlog',    'monitor/operlog/index',        '', 1, 0, 'C', '0', '0',  'monitor:operlog:list',     'form',          103, 1, sysdate, null, null, '操作日志菜单');
insert into sys_menu values('501',  '登录日志', '1', '2',   'logininfor', 'monitor/logininfor/index',     '', 1, 0, 'C', '0', '0',  'monitor:logininfor:list', 'logininfor',    103, 1, sysdate, null, null, '登录日志菜单');
