insert into sys_menu values('11616', '工作流'  , '0',    '6', 'workflow',          '',null,                                 '', '0', '1', 'M', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11617', '模型管理', '11616', '2', 'model',             'workflow/model/index','WorkflowModel',             '', '0', '1', 'C', '1', '1', 'workflow:model:list',    'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11618', '我的任务', '0', '7', 'task',              '',null,                                 '', '0', '1', 'M', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11619', '我的待办', '11618', '2', 'taskWaiting',       'workflow/task/taskWaiting','WorkflowTaskWaiting',              '', '0', '1', 'C', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11632', '我的已办', '11618', '3', 'taskFinish',       'workflow/task/taskFinish','WorkflowTaskFinish',              '', '0', '1', 'C', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11633', '我的抄送', '11618', '4', 'taskCopyList',       'workflow/task/taskCopyList','WorkflowTaskCopyList',              '', '0', '1', 'C', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11620', '流程定义', '11616', '3', 'processDefinition', 'workflow/processDefinition/index','WorkflowProcessDefinition', '', '0', '1', 'C', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11621', '流程实例', '11630', '1', 'processInstance',   'workflow/processInstance/index','WorkflowProcessInstance',   '', '0', '1', 'C', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11622', '流程分类', '11616', '1', 'category',          'workflow/category/index','WorkflowCategory',          '', '0', '1', 'C', '1', '1', 'workflow:category:list', 'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11629', '我发起的', '11618', '1', 'myDocument',        'workflow/task/myDocument','WorkflowMyDocument',         '', '0', '1', 'C', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11630', '流程监控', '11616', '4', 'monitor',           '',null,                                 '', '0', '1', 'M', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
insert into sys_menu values('11631', '待办任务', '11630', '2', 'allTaskWaiting',    'workflow/task/allTaskWaiting','WorkflowAllTaskWaiting',     '', '0', '1', 'C', '1', '1', '',                       'tree-table', null, null,103, 1, sysdate(), NULL, NULL, '');
