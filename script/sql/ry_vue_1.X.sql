...
insert into sys_menu values('3', '系统工具', '0', '14', 'tool',             null, null, '', 0, 1, 'M', '1', '1', '', 'tools',      103, 1, sysdate(), null, null, '系统工具目录');
insert into sys_menu values('4', 'PLUS官网', '0', '15', 'https://gitee.com/yixiacoco/ruoyi-tdesign', null, null, '', 1, 1, 'M', '1', '1', '', 'link',    103, 1, sysdate(), null, null, 'ruoyi-tdesign官网地址');
...
insert into sys_menu values('108',  '日志管理',     '1',   '9', 'log',              '',                             null,   '', 0, 1, 'M', '1', '1', '',                            'root-list',    103, 1, sysdate(), null, null, '日志管理菜单');
...
insert into sys_menu values('1604', '文件修改', '118', 5, '', NULL, NULL, NULL, 0, 1, 'F', '1', '1', 'system:oss:edit', '#', 103, 1, sysdate(), 1, sysdate(), '');
...
-- 消息管理
insert into sys_menu values('1801', '消息管理', '1', 11, 'messageManage', null, null, null, 0, 1, 'M', '1', '1', null, 'chat', 103, 1, sysdate(), 1, sysdate(), '');
-- 消息配置
...
insert into sys_menu values('1826', '发送测试消息', '1820', 6, '', null, null, null, 0, 1, 'F', '1', '1', 'system:messageTemplate:test', '#', 103, 1, sysdate(), 1, sysdate(), '');
-- 消息发送记录
