...
<br>
[![ruoyi-tdesign](https://img.shields.io/badge/ruoyi%20tdesign-1.0.0-success.svg)](https://gitee.com/yixiacoco/ruoyi-tdesign)
...
|----------|---------------------|-------------------------------------------------------------------------------------------------|----------------------------|
| 当前框架     | ruoyi-tdesign       | [ruoyi-tdesign文档](https://gitee.com/yixiacoco/ruoyi-tdesign/wikis/pages)                        | 重写RuoYi-Vue全方位升级(不兼容原框架)   |
| 原框架      | RuoYi-Vue-Plus      | [RuoYi-Vue官网](http://ruoyi.vip/)                                                                | 定期同步需要的功能                  |
