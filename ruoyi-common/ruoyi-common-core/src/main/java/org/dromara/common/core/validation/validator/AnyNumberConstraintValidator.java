...
import org.dromara.common.core.validation.AnyNumber;
 ...
 * @date 2020/5/10
 */
public class AnyNumberConstraintValidator implements ConstraintValidator<AnyNumber, Number> {
    /**
     * 数组
     */
    private int[] array;
     ...
     */
    @Override
    public void initialize(AnyNumber constraintAnnotation) {
    ...
    public boolean isValid(Number value, ConstraintValidatorContext context) {
        if (value != null) {
            for (int i : array) {
                if (value.equals(i) || value.intValue() == i) {
                    return true;
                }
            }
        }
