...
public class SysDictDataBo extends BaseEntity {
    ...
    @Size(max = 100, message = "字典类型长度不能超过{max}个字符", groups = { AddGroup.class, EditGroup.class })
    private String dictType;

    /**
     * 样式属性（其他样式扩展）
     */
    @Size(max = 100, message = "样式属性长度不能超过{max}个字符", groups = { AddGroup.class, EditGroup.class })
