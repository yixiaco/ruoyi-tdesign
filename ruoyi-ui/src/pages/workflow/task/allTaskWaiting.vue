<template>
  <t-card>
    ...
    <!-- 加签组件 -->
    <sys-user ref="sysUserRef" :multiple="true" @submit-callback="submitCallback" />
  </t-card>
</template>
...
import { getAllTaskFinishByPage, getAllTaskWaitByPage, updateAssignee } from '@/api/workflow/task';
